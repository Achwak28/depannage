    ...
    return <div className="commande__container">
        ...
        <div className="choose__van">
            <div className="choose__van-left">
                <MultiItems title="Choisissez le Supervan qui vous convient" items={supervans} selectedItemIndex={selectedItemIndex} onItemClick={handleItemClick} textPosition="bottom-right" />
                <MultiItems title="Prestation de manutention" items={trolley} selectedItemIndex={selectedItemIndex2} onItemClick={handleItemClick2} textPosition="top-left" />
                <MultiItems title="Choisissez le Supervan qui vous convient" items={supervans2} selectedItemIndex={selectedItemIndex3} onItemClick={handleItemClick3} textPosition="bottom-right" />
            </div>
